...
class user_login(db.Model):
    """clase para el control de login"""
...
def token_required(f):
    ...
    def decorated(*args, **kwargs):
        """jwt is passed in the request header, return 401 if token is not passed"""
        token = None
...
def get_all_users(current_user):
    """User Database Route this route sends back list of users"""
...
# Cambia el nombre de la variable que almacena los
# \resultados de la consulta a "games" (en minúscula y plural)
